...
- Files matching these patterns are excluded: **/node_modules/**, **/dist/**, **/build/**, **/.next/**, **/target/**, **/*.lock, **/pnpm-lock.yaml, **/package-lock.json, **/yarn.lock, **/*.db*, **/*.sqlite*, **/*.log, **/.env*, **/*.tsbuildinfo, **/images/**, **/*.{png,jpg,jpeg,gif,svg,ico,webp,pdf,zip}, **/.git/**, **/.github/**, **/.agents/**, **/.DS_Store, **/test_snapshots/**, **/__snapshots__/**, **/*.test.ts.snap, **/*.test.{ts,js,rs}, **/test.rs, **/*.spec.{ts,js}, **/*.xdr, payload.json, next-env.d.ts, **/.vercel/**, **/.turbo/**, **/coverage/**, **/.nyc_output/**, **/*.map, repomix-output.md
